...
<p>
  ...
  <table border="0" width="50%">
    ...
    <tr> <td style="background-color:#ffffff">Windows 64-bit (No XP support)</td> <td style="background-color:#ffffff"><a href="http://github.com/danmar/cppcheck/releases/download/1.85/cppcheck-1.85-x64-Setup.msi">Installer</a></td> </tr>
    <tr> <td style="background-color:#ccccff">Windows 32-bit (No XP support)</td> <td style="background-color:#ccccff"><a href="http://github.com/danmar/cppcheck/releases/download/1.85/cppcheck-1.85-x86-Setup.msi">Installer</a></td> </tr>
    <tr> <td style="background-color:#ffffff">Source code (.zip)</td><td style="background-color:#ffffff"><a href="https://github.com/danmar/cppcheck/archive/1.85.zip">Archive</a></td> </tr>
    <tr> <td style="background-color:#ccccff">Source code (.tar.gz)</td><td style="background-color:#ccccff"><a href="https://github.com/danmar/cppcheck/archive/1.85.tar.gz">Archive</a></td> </tr>
  </table>
